...
const ModalEdicionComponente = ({componenteEditar,setActivarEdicion}) => {
    ...
    useEffect (() => {
        const fetchPosts = async () => {
            const res = await clientAxios.get(`/componente/${componenteEditar}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const { data } = await clientAxios.put(`/componente/${componenteEditar}`, {
              name: nombre,
    ...
    const handleEliminar = () => {
        const url = `/componente/${componenteEditar}`;
        ...
        <div className="modal-overlay">
            <div className="modal-dialog flex flex-col">
                <div className="modal-content">
                    <h2 className="text-xl font-semibold mb-4 text-center">Editar componente</h2>
...
export default ModalEdicionComponente;
